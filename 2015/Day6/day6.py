...
def toggle(grid, corner1, corner2):
    grid[corner1[1]:corner2[1]+1, corner1[0]:corner2[0]+1] = -1 * grid[corner1[1]:corner2[1]+1, corner1[0]:corner2[0]+1] + 1
    return grid

def turnOff(grid, corner1, corner2):
    grid[corner1[1]:corner2[1]+1, corner1[0]:corner2[0]+1] = 0
    return grid
